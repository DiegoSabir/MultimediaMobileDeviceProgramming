        ...
        public void onClick(View v) {
            switch (v.getId()){
                case R.id.btnInsertar:
                    ...
                    intent = new Intent(MainActivity.this, Insertar.class);
                    //realizar la llamada
                ...
                case R.id.btnBorrar:
                    ...
                    intent = new Intent(MainActivity.this, Borrar.class);
                    //realizar la llamada
                    startActivity(intent);
                    break;
                ...
                case R.id.btnModificar:
                    ...
                    intent = new Intent(MainActivity.this, Modificar.class);
                    //realizar la llamada
                    startActivity(intent);
                    break;
                ...
                case R.id.btnConsultar1:
                    ...
                    intent = new Intent(MainActivity.this, Consultar.class);
                    //realizar la llamada
                    startActivity(intent);
                    break;
                ...
                case R.id.btnConsultarN:
                    ...
                    intent = new Intent(MainActivity.this, ConsultarN.class);
                    //realizar la llamada
                    startActivity(intent);
                    break;
                ...
                case R.id.btnConsultarNListView:
                    //llamar Activity ConsultarN
                    intent = new Intent(MainActivity.this, ConsultarNListView.class);
                    //realizar la llamada
                    startActivity(intent);
                    break;
            }

        ...
        btnEntendido.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (rbSi){
                    ...
                    intent.putExtra("hideViewId", getIntent().getIntExtra("hideViewId", -1)); // Pasar el ID de la vista a ocultar
                    finish();
    ...
    public void onClickBtn(View view){
        ...
        switch (view.getId()) {
            ...
            case R.id.btnInicio:
                ...
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP); // Esto limpia la pila de actividades
                startActivity(intent);
                break;
